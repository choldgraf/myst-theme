...
This page documents site-level UI components that appear on every page. They use the same configuration pattern through `site.parts` or `project.parts` in `myst.yml`.
